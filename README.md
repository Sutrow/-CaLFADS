...
**Медиана корреляции реконструкции = 0.793.** Это значит: для среднего нейрона модель объясняет ~63% дисперсии сигнала (r² = 0.793² ≈ 0.63). Было 0.63 (r² ≈ 0.40) в v3. Ноль нейронов с отрицательной корреляцией (были в v4).
