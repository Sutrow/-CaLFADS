...
**Медиана корреляции реконструкции = 0.793.** Это значит: для среднего нейрона модель объясняет 63% дисперсии сигнала ($r^2 = 0.793^2$ ≈ 0.63). Было 0.63 ($r^2$ ≈ 0.40) в v3. Ноль нейронов с отрицательной корреляцией (а они были в v4).
