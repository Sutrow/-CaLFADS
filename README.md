...
6. **Per-neuron noise model:** для каждого нейрона модель учит свой уровень шума $\sigma_n$. Нейроны с высоким SNR получают маленький $\sigma$ (модель уверена), шумные нейроны большой σ (модель "говорит", что не знает какой сигнал -- получается шумный нейрон). Это позволяет модели фокусироваться на информативных нейронах, не тратя ёмкость на шумные.
